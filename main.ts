function Question_3 () {
    Bullfrog = "Bullfrog"
    Snake = "Snake"
    game.showLongText("Which animal can't sleep?", DialogLayout.Top)
    story.showPlayerChoices("Snake", "Bullfrog")
    if (story.checkLastAnswer(Bullfrog)) {
        Game_Host.sayText("CORRECT!!")
        list.push("Q3 correct")
    }
    if (story.checkLastAnswer(Snake)) {
        Game_Host.sayText("WRONGG!!")
        list.push("Q3 wrong")
    }
}
function Question_1 () {
    Tallahasee = "Talhassee"
    Miamai = "Miami"
    game.showLongText("What is the capital of Florida", DialogLayout.Top)
    story.showPlayerChoices(Miamai, Tallahasee)
    if (story.checkLastAnswer(Tallahasee)) {
        Game_Host.sayText("CORRECT!!")
        list.push("Q1 correct")
    }
    if (story.checkLastAnswer(Miamai)) {
        Game_Host.sayText("WRONGG!!")
        list.push("Q1 wrong")
    }
}
function Question_2 () {
    ...
    Wii = "Wii"
    game.showLongText("What is all time best selling nintendo console", DialogLayout.Top)
    story.showPlayerChoices("Wii", "Nintendo switch")
    if (story.checkLastAnswer(Wii)) {
        Game_Host.sayText("CORRECT!!")
        list.push("Q2 correct")
    }
    if (story.checkLastAnswer(Nintendo_switch)) {
        Game_Host.sayText("WRONGG!!")
        list.push("Q2 wrong")
    }
}
